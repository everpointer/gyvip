...
class AVRestClient{
	...
	public function __construct(){
		$AVConfig = (require 'AVConfig.php');
		$this->_appid = $AVConfig['app_id'];
    	$this->_masterkey = $AVConfig['master_key'];
    	$this->_appkey = $AVConfig['app_key'];
    	$this->_AVurl = $AVConfig['leancloud_url'];
